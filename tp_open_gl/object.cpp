...
Object::Object(std::vector<glm::vec3> vertices, std::vector<glm::vec2> uvs, std::vector<glm::vec3> normales, std::string texturePath)
    :m_vb(0), m_uvsb(0), m_normalsb(0), m_texture(0), position(0,0,0), rotationAngles(0,0,0)
{
     ...
     m_normalsb = new VertexBuffer(normales);
    ...
    :m_vb(0), m_uvsb(0), m_normalsb(0), m_texture(0), position(0,0,0), rotationAngles(0,0,0)
{
    ...
    loadOBJ(objPath, vertices, uvs, normales);
...
bool Object::Object::loadOBJ(const char *path, std::vector<glm::vec3> &out_vertices, std::vector<glm::vec2> &out_uvs, std::vector<glm::vec3> &out_normals)
{
