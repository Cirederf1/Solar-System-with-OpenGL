...
Shader::Shader(std::string vertexShaderFilePath, std::string fragmentShaderFilePath):m_VertexShaderFilePath(vertexShaderFilePath), m_FragmentShaderFilePath(fragmentShaderFilePath), m_RendererID(0)
{
